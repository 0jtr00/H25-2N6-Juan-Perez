...
#  Vous devez dans un premier temps séparer les données sur le caractère qui les séparent ( le ';' ici )
...
print(f"Q1{'_'*60}")
lignedonnes1 =ligne_donnees.split(";")
for i in lignedonnes1 :
    i.strip()
print(lignedonnes1)
...
print(f"Q2{'_'*60}")
abas = nom_fichier_et_extension.split(".")
mon = nom_fichier_et_extension.split("_")
print(mon)
...
#  triez cette liste en nombres croissants tout en conservant la liste de nombres originale ( avec la fonction sorted() )
